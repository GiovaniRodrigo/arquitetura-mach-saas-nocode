// Comando deploy sobe o Deploy Engine gRPC (RF04).
package main
...
func main() {
	...
	shutdown, err := telemetry.Init(ctx, telemetry.Config{ServiceName: "deploy", OTLPEndpoint: otlp})
	if err != nil {
	...
	log.Printf("Deploy Engine ouvindo em %s", addr)
