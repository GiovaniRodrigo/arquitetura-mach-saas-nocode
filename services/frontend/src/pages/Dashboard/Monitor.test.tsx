...
import { autenticarNoMonitor, sairDoMonitor, MONITOR_LOGIN, MONITOR_SENHA } from '../../dashboard/monitorAuth';
import { renderDashboard, fakeClient } from '../../test/renderDashboard';

// O gate de login (MonitorLoginGate) tem cobertura própria em
// MonitorLoginGate.test.tsx — aqui destravamos de antemão para testar só o
// conteúdo da tela.
beforeEach(() => {
  autenticarNoMonitor(MONITOR_LOGIN, MONITOR_SENHA);
});
afterEach(() => {
  sairDoMonitor();
});
