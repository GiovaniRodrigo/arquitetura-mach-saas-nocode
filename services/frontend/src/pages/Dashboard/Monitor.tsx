...
// Acesso restrito por login/senha fixos (MonitorLoginGate) — ver monitorAuth.ts.
...
import { MonitorLoginGate } from '../../dashboard/MonitorLoginGate';
